  ...
  stages {
   ...
   stage('Docker build and push') {
	 ...
	 echo $access_key
         ...
         docker login -u AWS -p $DOCKER_LOGIN_PASSWORD https://480286637739.dkr.ecr.ap-south-1.amazonaws.com
         docker build -t 480286637739.dkr.ecr.ap-south-1.amazonaws.com/demo/sample:SAMPLE-PROJECT-${BUILD_NUMBER} .
         docker push 480286637739.dkr.ecr.ap-south-1.amazonaws.com/demo/sample:SAMPLE-PROJECT-${BUILD_NUMBER}
